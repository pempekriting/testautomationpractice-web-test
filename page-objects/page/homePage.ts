...
export class HomePage extends HelperBase {
    ...
    constructor(page: Page) {
        ...
        this.paragraphSuccessIndicatorUploadSingleFile = page.locator(`#singleFileStatus`);
        this.paragraphSuccessIndicatorUploadMultipleFile = page.locator(`#multipleFilesStatus`);
    }
    ...
    async uploadFiles() {
        await this.inpUploadSingleFile.setInputFiles(path.join(`${process.cwd()}/data`, `pict-1.jpg`));
    ...
    async assertionInputs() {
        ...
        expect(this.paragraphSuccessIndicatorUploadSingleFile).toContainText(`Single file selected: pict-1.jpg`);
        expect(this.paragraphSuccessIndicatorUploadMultipleFile).toBeVisible();
        const text = await this.paragraphSuccessIndicatorUploadMultipleFile.textContent();
